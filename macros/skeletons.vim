...
"  next couple of things require environment variables being set
  exe "%s/skeletonVIM_USER_NAME/" . $VIM_USER_NAME . "/ge"
  exe "%s/skeletonVIM_COPYRIGHT/" . $VIM_COPYRIGHT . "/ge"
  exe "%s/skeletonVIM_USER_EMAIL/" . $VIM_USER_EMAIL . "/ge"
  exe "%s/skeletonVIM_USER_TITLE/" . $VIM_USER_TITLE . "/ge"
  exe "%s/skeletonVIM_DATE/" . $VIM_DATE . "/ge"
  exe "%s/skeletonVIM_PERLEND/__END__/ge"
  exe "%s/skeletonVIM_POD_HEAD/=head1/ge"
endfunction
